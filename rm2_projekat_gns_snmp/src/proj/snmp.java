...
public abstract class snmp 
{
    ...
    protected static boolean     _numericalOID = false;
     ...
     */
    protected static void print(SnmpVarBind[] varbinds)
    {
     ...
     */
    protected static void print(SnmpVarBind[] varbinds, PrintStream p)
    {
     ...
     */
    protected static void print(SnmpVarBind var, PrintStream p)
    {
        if(var == null)
        {
            return;
